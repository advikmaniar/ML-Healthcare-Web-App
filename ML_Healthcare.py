...
def get_dataset(dataset_name):
    if dataset_name=="Heart Attack":
        data=pd.read_csv("https://github.com/advikmaniar/ML-Heathcare-Web-App/blob/main/Data/heart.csv",delimiter=",",names=['age', 'sex', 'cp', 'trtbps', 'chol', 'fbs', 'restecg', 'thalachh',
       'exng', 'oldpeak', 'slp', 'caa', 'thall', 'output'])
        st.header("Heart Attack Prediction")
        return data

    else:
        data=pd.read_csv("https://github.com/advikmaniar/ML-Heathcare-Web-App/blob/main/Data/BreastCancer.csv",delimiter=",",names=['diagnosis', 'radius_mean', 'texture_mean', 'perimeter_mean',
