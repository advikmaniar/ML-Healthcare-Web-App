...
def get_dataset(dataset_name):
    if dataset_name=="Heart Attack":
        data=pd.read_csv("https://github.com/advikmaniar/ML-Heathcare-Web-App/blob/main/Data/heart.csv",sep='delimiter', header=None)
        st.header("Heart Attack Prediction")
        return data

    else:
        data=pd.read_csv("https://github.com/advikmaniar/ML-Heathcare-Web-App/blob/main/Data/BreastCancer.csv",sep='delimiter', header=None)
